...
infoln "Joining Cipla peer to the channel..."
joinChannel 1
infoln "Joining Medlife peer to the channel..."
joinChannel 2
infoln "Joining Apollo peer to the channel..."
joinChannel 4
infoln "Joining CDSCO peer to the channel..."
joinChannel 5

## Set the anchor peers for each org in the channel
infoln "Setting anchor peer for Cipla..."
setAnchorPeer 1
infoln "Setting anchor peer for Medlife..."
setAnchorPeer 2
infoln "Setting anchor peer for Apollo..."
setAnchorPeer 4
infoln "Setting anchor peer for CDSCO..."
setAnchorPeer 5
